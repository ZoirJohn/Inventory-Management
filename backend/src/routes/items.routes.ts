	...
	try {
		const allItems = await db
			.select({
				...
				text2: items.text2,
				text3: items.text3,
				multiline1: items.multiline1,
				multiline2: items.multiline2,
				multiline3: items.multiline3,
				...
				link2: items.link2,
				link3: items.link3,
				checkbox1: items.checkbox1,
				checkbox2: items.checkbox2,
				checkbox3: items.checkbox3,
