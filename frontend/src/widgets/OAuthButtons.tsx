...
export function Facebook() {
	return (
		<Button onClick={client.AUTH_FACEBOOK}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="size-4 fill-foreground">
...
export function Google() {
	return (
		<Button onClick={client.AUTH_GOOGLE}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="size-4 fill-foreground">
