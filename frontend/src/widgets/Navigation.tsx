	...
	return (
		<nav>
			<div className="flex items-center gap-4 h-16 container">
				...
				<div className="flex gap-2">
					<Button onClick={changeTheme} className="bg-default-100 hover:bg-default-200 min-w-0">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="dark:hidden fill-foreground size-4">
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="hidden dark:block fill-foreground size-4">
